  ...
  providers: [
    {
      ...
      useExisting: forwardRef(() => RecruiterComponent),
      multi: true
    }
  ]
})
export class RecruiterComponent implements ControlValueAccessor{
  ...
  // id: any;
  // RecruiterCost:string;
  // user:any;
  // recruiterCostList: any;
  // checkCost: any;
  // show: boolean= false;
  ...
  //   var data = {
  //     jobProfileid:this.id,
  //     Recruiterid:this.user 
  //   };

  //   this.bidEventService.getRecruiterCostById(data).subscribe((res)=>{
  //     this.checkCost = res;
  //     })
  //   this.getAllRecruiterCosts();
  // }
  // getAllRecruiterCosts(){
  //   this.bidEventService.getAllRecruiterCost(this.id).subscribe((res)=>{
  //     this.recruiterCostList = res;
      
  //   })
  // }
  // showCostDiv(){
  //   jQuery('#addorupdatecost').modal('open');
  // }
  // AddCost(){
   
  //   var info = {
  //         cost:this.RecruiterCost, // required
  //         jobProfileid:this.id,
  //         Recruiterid:this.user 
  //  };
  //   this.bidEventService.addRecruiterCost(info).subscribe((res)=>{
  //    this.getAllRecruiterCosts();
  //    jQuery('#addorupdatecost').modal('close');
  //   })
  // }
  // UpdateCost(){
  ...
  //   this.bidEventService.updateRecruiterCost(info).subscribe((res)=>{
  //      this.getAllRecruiterCosts();
  //      jQuery('#addorupdatecost').modal('close');
  //     })
  //   }
