...
const appRoutes: Routes = [
  ...
  { path:'employer',component:EmployerHomeComponent,canActivate:[AuthGuard]},
  { path:'recruiter',component:RecruiterHomeComponent,canActivate:[AuthGuard]},
  { path:'bidding-events/details/:key',component:BiddingEventDetailsComponent,canActivate:[AuthGuard]},
  { path:'event/feedback/candidate/resumes/:key',component:RecruiterFeedbackComponent},
  { path:'user/email/verification/check/:key',component:EmailVerificationComponent},  
  { path:'user/forgot/password/check/hireseat/:key',component:ForgotPasswordResetComponent},  
...
@NgModule({
  ...
  imports: [
    ...
    BrowserModule, HttpClientModule,NgxCurrencyModule, FormsModule, ReactiveFormsModule,NgxSpinnerModule,NgxPaginationModule,
